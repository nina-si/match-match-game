  ...
  constructor(action: string, method: string) {
    ...
    this.element.innerHTML = `
      <div class="input-group">
        ...
        <input id="first-name" placeholder="John" type="text" class="input">
      ...
      <div class="input-group">
        ...
        <input id="last-name" placeholder="Doe" type="text" class="input">
        <span class="error-message"></span>
        <svg class="icon icon-success hidden hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
        </svg>
      ...
      <div class="input-group">
        ...
        <input id="email" placeholder="johndoe@gmail.com" type="email" class="input">
        <span class="error-message"></span>
        <svg class="icon icon-success hidden hidden" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
        </svg>
      ...
      <input type='submit' class='submit-btn' value='Register' disabled>
